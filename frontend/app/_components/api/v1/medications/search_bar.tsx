...
export default function SearchBar({handleSearchChange, searchTerm, setSearchTerm, selectedMedicineId, setSelectedMedicineId, selectedDoses, setSelectedDoses, detailsMedicineId, setDetailsMedicineId}: any) {
