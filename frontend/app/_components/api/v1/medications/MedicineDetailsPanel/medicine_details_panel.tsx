...
export function MobileDetailsOverlay({ medicine, onClose }: Props) {
...
export default function MedicineDetailsPanel({ medicine, onClose }: Props) {
  const availableDoses = medicine.doses.filter((dose) => dose !== "Sve");
  const hasActiveIngredients = medicine.activeIngredients.length > 0;
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-slate-700">
                  Prikazane informacije služe isključivo u informativne svrhe i
